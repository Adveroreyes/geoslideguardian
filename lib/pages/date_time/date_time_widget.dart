                ...
                child: Column(
                  ...
                  children: [
                        ...
                        Row(
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: Image.network(
                                'https://firebasestorage.googleapis.com/v0/b/geoslide-psm.appspot.com/o/1.png?alt=media&token=854c7719-eedf-4d6f-b367-a3e86624d42c',
                                width: 392.0,
                                height: 200.0,
                                fit: BoxFit.cover,
                              ),
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await DatepickedRecord.collection
                              .doc()
                              .set(createDatepickedRecordData(
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(200.0, 50.0, 0.0, 0.0),
                      child: FFButtonWidget(
                        onPressed: () async {
                          context.pushNamed('RealTime');
                        },
                        text: 'Next',
                        options: FFButtonOptions(
                          height: 40.0,
